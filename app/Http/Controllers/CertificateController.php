...
class CertificateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // return $certificate;
            Http::get('http://whatsapp.tecnologiaweb.org/?number=591'.$certificate->company->phone.'&message=Hola *'.$certificate->company->representative.'*.%0A%0A*GADBENI* %0A%0APara poder descargar su certificado *CODIGO OPERADOR MINERO*%0A%0AHas clic en el enlace de abajo.%0A👇👇%0Ahttps://mineria.beni.gob.bo/certificates/'.$certificate->id.'/print');
